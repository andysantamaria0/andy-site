...
-- Trip members can view their trips
...
-- Members can see co-members of their trips
...
-- Authenticated users can add themselves (for trip creation / invite acceptance)
...
-- Members can update their own membership (stay dates, color)
